...
{
    TensionSmoother2::TensionSmoother2(const std::vector<PathPlannerNS::State> &input_points,
                                       const PathPlannerNS::State &start_state,
                                       const PathPlannerNS::Map &grid_map) : TensionSmoother(input_points, start_state, grid_map) {}
