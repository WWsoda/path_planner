//
// Created by wwsoda on 22-4-30
//

#ifndef PATH_PLANNER_INCLUDE_PATH_PLANNER_DATA_STRUCT_REFERENCE_PATH_IMPL_HPP_
#define PATH_PLANNER_INCLUDE_PATH_PLANNER_DATA_STRUCT_REFERENCE_PATH_IMPL_HPP_
#include <vector>
#include <tuple>
#include <memory>
...
namespace PathPlannerNS
{
    ...
    private:
        std::vector<double> getClearanceWithDirectionStrict(const PathPlannerNS::State &state,
...
#endif // PATH_PLANNER_INCLUDE_PATH_PLANNER_DATA_STRUCT_REFERENCE_PATH_IMPL_HPP_
