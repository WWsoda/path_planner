...
#ifndef PATH_PLANNER_INCLUDE_PATH_PLANNER_CONFIG_FLAGS_HPP_
#define PATH_PLANNER_INCLUDE_PATH_PLANNER_CONFIG_FLAGS_HPP_
...
#endif // PATH_PLANNER_INCLUDE_PATH_PLANNER_CONFIG_PLANNING_FLAGS_HPP_